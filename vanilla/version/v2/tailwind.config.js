...
module.exports = {
  // Sesuaikan path ini dengan struktur project Anda (misal: "./src/**/*.{html,js}")
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        scorePop: { '0%': { transform: 'scale(1)' }, '50%': { transform: 'scale(1.5)', color: '#fbbf24' }, '100%': { transform: 'scale(1)' } },
        firePulse: { '0%, 100%': { opacity: '1', transform: 'scale(1)' }, '50%': { opacity: '0.8', transform: 'scale(1.05)' } },
        ...
        bgPan: { '0%': { backgroundPosition: '0% 50%' }, '50%': { backgroundPosition: '100% 50%' }, '100%': { backgroundPosition: '0% 50%' } },
        heatWave: { '0%': { opacity: '0.3' }, '50%': { opacity: '0.6' }, '100%': { opacity: '0.3' } },
        logoShake: { '0%, 100%': { transform: 'rotate(0deg)' }, '2%': { transform: 'rotate(-2deg)' }, '4%': { transform: 'rotate(2deg)' }, '6%': { transform: 'rotate(0deg)' } },
        fillBar: { '0%': { width: '0%' }, '100%': { width: '100%' } }
      }
    }
  },
  plugins: [],
